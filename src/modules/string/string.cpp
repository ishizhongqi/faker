...
std::string uuid(const bool include_hyphens) {
    ...
    if (include_hyphens) {
        oss << std::setw(8) << data1 << "-" << std::setw(4) << data2 << "-" << std::setw(4) << data3 << "-"
            << std::setw(4) << data4 << "-" << std::setw(12) << (data5 & 0xFFFFFFFFFFFF);
    } else {
        oss << std::setw(8) << data1 << std::setw(4) << data2 << std::setw(4) << data3 << std::setw(4) << data4
            << std::setw(12) << (data5 & 0xFFFFFFFFFFFF);
    }
